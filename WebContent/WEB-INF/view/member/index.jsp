...
<body>
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-good">
			...
			<dd>
				<ul>
					<li><a data-href="<%=path %>/goodsCtrl/queryGoods?currpage=1" data-title="商品管理"
						href="javascript:void(0)">现有商品列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-pay">
			<dt>
				<i class="Hui-iconfont">&#xe60d;</i> 兑换商品记录<i
					class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
					<li><a data-href="<%=path %>/exchangeCtrl/queryExchange?currpage=1" data-title="查看选课记录"
						href="javascript:void(0)">查看兑换记录</a></li>
				</ul>
			</dd>
		</dl>
	</div>
	...
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="个人信息" data-href="<%=path %>/common/member/welcome">个人信息</span>
					<em></em></li>
			</ul>
		</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="<%=path %>/common/member/welcome"></iframe>
		</div>
	</div>
	</section>
