...
<title>分配课程 - 会员管理 </title>
</head>
<body>
	<article class="page-container">
	<form action="<%=path %>/givelessonsCtrl/insertGivelessons" method="post" class="form form-horizontal"
		id="form-change-password">
			<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span
				class="c-red">*</span>课程编号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${Course.courseId }" placeholder=""
					id="courseId" name="courseId" readonly="readonly">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span
				class="c-red">*</span>分配教练：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="输入教练编号"
